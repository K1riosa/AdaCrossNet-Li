...
class DGCNN_partseg(nn.Module):
    def __init__(self, args, seg_num_all=None, pretrain=True):
        ...
        self.attention1 = CBAM(64, reduction_ratio=8, kernel_size=5)
        self.attention2 = CBAM(64, reduction_ratio=8, kernel_size=5)
        self.attention3 = CBAM(64, reduction_ratio=8, kernel_size=5)
    ...
    def forward(self, x, l=None):
        ...
        x0 = get_graph_feature(x, k=self.k, device=self.gpu, use_adaptive_knn=True)
...
class Transform_Net(nn.Module):
    def __init__(self, args):
        ...
        # 添加注意力
        self.attention = CBAM(64, reduction_ratio=8, kernel_size=5)
